...
// Insert
@Insert("insert into tbl_wiki(wiki_pno, wiki_user_fno, wiki_title, wiki_content, wiki_code, wiki_lang) values(seq_wiki.nextval, #{wiki_user_fno}, #{wiki_title}, #{wiki_content}, #{wiki_code}, #{wiki_lang})")
